    ...
    publications {
        ...
        create<MavenPublication>("mavenJava") {
            ...
            pom.withXml {
                ...
                asNode().appendNode("url", "https://isanchez.net")
                ...
                asNode().appendNode("scm")
                    .appendNode("url", "https://github.com/s4nchez/${rootProject.name}").parent()
                    .appendNode("connection", "scm:git:git@github.com:s4nchez/${rootProject.name}.git").parent()
                    .appendNode("developerConnection", "scm:git:git@github.com:s4nchez/${rootProject.name}.git")
